...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" 
    ...
    <head>
        ...
        <style>
            ...
            .dark .bg-white, .dark .bg-gray-50, .dark .bg-gray-50\/50, .dark .bg-gray-50\/80 {
                background-color: #1e293b !important; /* Warna kartu gelap */
                border-color: #334155 !important;    /* Warna garis pinggir gelap */
                box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.3) !important; /* Bayangan halus */
            }
    ...
    <body class="font-sans antialiased text-gray-900 bg-gray-100 dark:bg-gray-900 dark:text-gray-100 transition-colors duration-300">
